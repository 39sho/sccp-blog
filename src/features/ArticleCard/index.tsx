...
export default ({ url, title, date, children }: props) => {
    return (
        <a href={url} className="bg-gray-50 dark:bg-gray-950 dark:text-white flex w-11/12 max-w-4xl h-48 py-5 px-10 flex-col items-start gap-3 rounded-xl border-solid border-2">
